...
public class MultiplyInstruction implements IInstruction {
     ...
     */
    public MultiplyInstruction(int assignmentOperandValue, int[] operandValues) {
    ...
    public void getStringRepresentation() {
       System.out.println(" MUL "+assignmentOperandValue+" "+operandValues[0]+" "+operandValues[1]);
    }
	...
	public IInstruction copy() {
		...
		return new MultiplyInstruction(assignmentOperandValue,newOperandArray);
	}
	...
	public String toString(){
		return " MUL "+assignmentOperandValue+" "+operandValues[0]+" "+operandValues[1];
	}
