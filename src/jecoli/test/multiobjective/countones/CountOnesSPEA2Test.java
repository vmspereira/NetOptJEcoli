...
public class CountOnesSPEA2Test {
	...
	public static void main(String[] args) {
		try {
			SPEA2Configuration<ILinearRepresentation<Boolean>,BinaryRepresentationFactory> configuration = new SPEA2Configuration<ILinearRepresentation<Boolean>,BinaryRepresentationFactory>();
