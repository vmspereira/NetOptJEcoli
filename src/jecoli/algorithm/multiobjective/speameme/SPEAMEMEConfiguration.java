 ...
 */
public class SPEAMEMEConfiguration<T extends IRepresentation, S extends ISolutionFactory<T>> extends AbstractConfiguration<T> {
	...
	@Override
	public SPEAMEMEConfiguration<T,S> deepCopy() throws Exception {
		//TODO
		return null;
	}
