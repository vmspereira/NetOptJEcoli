 ...
 */
public class SPEA2AlgorithmState<T extends IRepresentation> extends AlgorithmState<T> implements IArchivedAlgorithmState<T>{
	 ...
	 */
	public SPEA2AlgorithmState(IAlgorithm<T> algorithm) {
		super(algorithm);
	}
